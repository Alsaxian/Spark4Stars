...
class Spark4Stars1Test extends FunSuite with BeforeAndAfter {
...
//  }
  ...
  test("Vérifie la version case class avec source-sample") {
    val resultat = Spark4Stars1.calculMaxMin("samples/source-sample", sc)
